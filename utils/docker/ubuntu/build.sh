...
docker_build Dockerfile.build-gcc-ci      ubuntu-gcc-ci       \
    --build-arg "BASE=${NAME}:ubuntu-gcc"
docker_build Dockerfile.build-clang-ci    ubuntu-clang-ci     \
    --build-arg "BASE=${NAME}:ubuntu-clang"
docker_build Dockerfile.build-evm-llvm-ci ubuntu-evm-llvm-ci  \
    --build-arg "BASE=${NAME}:ubuntu-evm-llvm"
